...
**Файлы изменены:** user/choices.py, user/services.py, vacancy/views.py, vacancy/forms.py, vacancy/services/call_formatter.py, vacancy/services/call_markup.py, vacancy/services/observers/call_observer.py, vacancy/templates/vacancy/pre_call.html, vacancy/templates/vacancy/call.html, vacancy/templates/vacancy/vacancy_form.html
