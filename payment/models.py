...
class MonobankPayment(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name="monobank_payments"
    )
    vacancy = models.ForeignKey(
        "vacancy.Vacancy", on_delete=models.SET_NULL, null=True, blank=True, related_name="monobank_payments"
    )
