...
from work.forms import AgreementForm, CityForm, GenderForm, RoleForm
...
class ProfileWizard(SessionWizardView):
    ...
    def done(self, form_list, **kwargs):
        ...
        profile.save(update_fields=["role", "city", "agreement_accepted", "agreement_accepted_at", "is_completed"])
