...
from .views import (
    ...
    vacancy_continue_search,
    vacancy_create,
    vacancy_detail,
    vacancy_kick_member,
    vacancy_members,
    vacancy_members_json,
    vacancy_my_list,
    vacancy_payment,
...
urlpatterns = [
    ...
    path("<int:pk>/continue-search/", vacancy_continue_search, name="continue_search"),
    path("<int:pk>/close-lifecycle/", vacancy_close_lifecycle, name="close_lifecycle"),
    path("<int:pk>/members/", vacancy_members, name="members"),
    path("<int:pk>/members-json/", vacancy_members_json, name="members_json"),
